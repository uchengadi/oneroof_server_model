...
class Timezones extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('timezone, description', 'length', 'max'=>200),
			array('create_time, update_time', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, timezone, offset, description, create_time, update_time, create_user_id, update_user_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'platformSettings' => array(self::HAS_MANY, 'PlatformSettings', 'platform_default_time_zone_id'),
			'stores' => array(self::HAS_MANY, 'Stores', 'timezone_id'),
		);
	}
